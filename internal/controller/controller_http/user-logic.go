...
func (r ControllerHttp) UserSignUp() error {
	id := "signup-error"
	req := new(model_http.UserSignUp)
...
// Uses the form request information.
func (r ControllerHttp) UserLogin() error {
	id := "login-error"
	req := new(model_http.UserLogin)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
...
func (r ControllerHttp) UserLogout() error {
...
// Uses the form request information.
func (r ControllerHttp) UserChangeName() error {
	id := "change-name-error"
	req := new(model_http.UserChangeName)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
	...
	if req.NewNickname == user.Nick && req.NewUsername == user.Name {
		return r.RenderWarning(i18n.MessageErrUselessChange, id)
	}
...
// Uses the form request information.
func (r ControllerHttp) UserChangeEmail() error {
	id := "change-email-error"
	req := new(model_http.UserChangeEmail)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
...
// Uses the form request information.
func (r ControllerHttp) UserChangePhone() error {
	id := "change-phone-error"
	req := new(model_http.UserChangePhone)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
...
// Uses the form request information.
func (r ControllerHttp) UserChangePassword() error {
	id := "change-password-error"
	req := new(model_http.UserChangePassword)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
...
// Uses the form request information.
func (r ControllerHttp) UserDelete() error {
	id := "account-delete-error"
	req := new(model_http.UserDelete)
	err := r.Ctx.Bind().Form(req)
	if err != nil {
		return r.RenderInternalError(id)
	}
...
func (r ControllerHttp) GiveToken(errorElementId string, user model_database.User) error {
